...
import "@/pages/admin/admin-style/ad_add_product.css";
                ...
                <aside className="sidebar">
                    ...
                    <div className="nav">
                        ...
                        <div className="submenu" id="menu-ecom" style={{ display: "block" }}>
                            <a className="sub-item" href="/admin/products/new">Add Product</a>
                            <a className="sub-item active" href="/admin/products">Product List</a>
                        </div>
                    ...
                    <div className="nav">
                        ...
                        <div className="submenu" id="menu-order" style={{ display: "block" }}>
                            <a className="sub-item" href="/admin/orders">Order List</a>
                            <a className="sub-item" href="/admin/orders/1">Order Detail</a>
                            <a className="sub-item" href="/tracking/123">Order Tracking</a>
                        </div>
